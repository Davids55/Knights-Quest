...
LAYER_NAME_ENEMIES = "ouch"
LAYER_NAME_WIN = "banner"
...
class PlayerCharacter(arcade.Sprite):
    ...
    def __init__(self):
        ...
        self.jump_texture_pair = load_texture_pair(f"{main_path}/jump/jump_0.png")
        self.fall_texture_pair = load_texture_pair(f"{main_path}/fall/fall_0.png")
        self.swing_texture_pair = load_texture_pair(f"{main_path}/swing/swing_3.png")
...
class MyGame(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        self.scene.update_animation(
            delta_time, [LAYER_NAME_COINS, LAYER_NAME_BACKGROUND, LAYER_NAME_PLAYER, LAYER_NAME_WIN]
        )
        ...
        win_hit_list = arcade.check_for_collision_with_list(
            self.player_sprite, self.scene[LAYER_NAME_WIN]
        )


        for banner in win_hit_list:
            ...
            # Remove the coin
            banner.remove_from_sprite_lists()
            arcade.play_sound(self.collect_coin_sound)    
